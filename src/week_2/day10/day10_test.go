...
func TestSolvePart2_example(t *testing.T) {
	var expected = 4
	result := SolvePart2("../../../resources/day_10_example.txt")
...
func TestSolvePart2_example2(t *testing.T) {
	var expected = 8
	result := SolvePart2("../../../resources/day_10_example_2.txt")
...
func TestSolvePart2_example3(t *testing.T) {
	var expected = 10
	result := SolvePart2("../../../resources/day_10_example_3.txt")
...
func TestSolvePart2(t *testing.T) {
	var expected = 8
	result := SolvePart2("../../../resources/day_10.txt")
